...
public class HomeActivity extends AppCompatActivity {
    ...
    CircleButton addCiclo, resultCUM;
    TextView myCUM;
    String cum_total;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addCiclo = findViewById(R.id.nuevo_ciclo_cb);
        resultCUM = findViewById(R.id.cal_cum_cb);

        addCiclo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(HomeActivity.this, CalcularCUMActivity.class);
                startActivity(intent);
            }
        });
        resultCUM.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
    ...
    private void accessPermission() {
        if(ContextCompat.checkSelfPermission(HomeActivity.this,
            ...
            Toast.makeText(HomeActivity.this, "Acerca de", Toast.LENGTH_LONG).show();
        }
        else{
