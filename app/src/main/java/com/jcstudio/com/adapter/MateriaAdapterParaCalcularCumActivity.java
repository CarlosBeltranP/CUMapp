...
public class MateriaAdapterParaCalcularCumActivity extends RecyclerView.Adapter<MateriaAdapterParaCalcularCumActivity.MyViewHolder>{
    ...
    public MateriaAdapterParaCalcularCumActivity(Context context, List<Materia> materias_list){
    ...
    class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            dialogActivity.showDialogUpdateDeleteParaCalcularCumActivity(materiaList, getAdapterPosition());
